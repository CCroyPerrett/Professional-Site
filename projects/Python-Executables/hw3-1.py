...
def pluralize_english_word(word):
    ...
    if(word == "mouse" or word == "Mouse"):
        ...
        return word + "es"
    # the "ends with o" above could have just been added to this function below,
    # since they have the same output, but they're separeted to be sure to fit in with
